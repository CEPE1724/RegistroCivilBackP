...
export class CreVerificacionTelefonicaMaestro {
    ...
    @OneToMany(() => CreSolicitudverificaciontelefonica, c => c.creVerificacionTelefonicaMaestro)
    cre_SolicitudVerificacionTelefonica: CreSolicitudverificaciontelefonica[];
